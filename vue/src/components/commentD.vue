<template>
    ...
    <div style="padding:160px;margin-left: 0px">
        ...
        <el-table :data="tableData" stripe border style="width: 100%">
            ...
            <el-table-column   width="200">
                <template #default="scope">
                    <el-button type="primary" style="background-color:#F49506" size="mini" @click="orderDetail1(scope.row);dialogVisible1=true">详情</el-button>
                    <el-button type="primary" style="background-color:#F49506" size="mini" @click="orderDetail(scope.row);dialogVisible=true">查看评价</el-button>
                </template>
            </el-table-column>
        </el-table>
    ...
    <div style="margin: 0px 50px">
        <el-dialog title="订单详情" v-model="dialogVisible" width="30%">
            <el-table :data="tableData3">
                ...
                >
                    <template #default="scope">
                    <el-rate v-model="scope.row.delCom"></el-rate>
                    </template>
                </el-table-column>
                <el-table-column
                        label="外卖员评价"
    ...
    <div style="margin: 0px 50px">
        <el-dialog title="订单详情" v-model="dialogVisible1" width="30%">
            ...
            <span style="margin: 0 80px">
                    <el-button type="primary" style="background-color:#F49506" @click="dialogVisible1=false">确 定</el-button>
                    </span>
        </el-dialog>
    </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            orderDetail1(e){   //显示订单详情  食物，顾客的手机号等等
