<template>
    ...
    >
      <!--  <el-table-column
        ...
        >
            <template #default="scope">
                <el-button type="primary" style="background-color:#F49506" @click="updateDD(scope.row)">接单</el-button>
            </template>
        </el-table-column>
       <!-- <el-table-column
                fixed
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            updateDD(e){   //status 1 为 接单，0为未接单
                request.get('/api/deliver/updateDD',{
                    params:{
                        orderNumber:e.orderNumber,
