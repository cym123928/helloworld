<template>
    <div style="height: 50px;line-height: 50px;border-bottom: 1px solid #ccc; display: flex;position: absolute">
        ...
        <div>
            ...
            >
                <el-menu-item index="/unReceiveD">
                    <el-icon><document /></el-icon>
                    <span>外卖接单</span>
                </el-menu-item>
                <el-menu-item index="/receivedOrderD">
                    <el-icon><document /></el-icon>
                    <span>配送中订单</span>
                </el-menu-item>
                <el-menu-item index="/finishedD">
                    <el-icon><document /></el-icon>
                    <span>已完成订单</span>
                </el-menu-item>
                <el-menu-item index="/commentD">
                    <el-icon><document /></el-icon>
                    <span>查看评价</span>
                </el-menu-item>
            </el-menu>
    ...
    export default {
        ...
        data(){
            return{
                dialogVisible:false,
                user:{
                    name: sessionStorage.getItem("username2"),
