<template>
    ...
    <div style="padding:10px;margin-left: 120px">
        ...
        <el-table :data="tableData" stripe border style="width: 100%">
            ...
            <el-table-column prop="city" label="地址" width="400" />
            <el-table-column prop="scale" label="规模大小" width="100"  />
    ...
    export default {
        ...
        methods: {
            ...
            change(e) {
                ...
                sessionStorage.setItem("numberRC", e.number.toString())   //餐厅号  为了查询评价
                this.$router.push('/CommentRes')
            },
